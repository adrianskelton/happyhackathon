...
REST_AUTH_SERIALIZERS = {
    'USER_DETAILS_SERIALIZER': 'positive.serializers.CurrentUserSerializer'
}
...
ALLOWED_HOSTS = ['localhost', 'positive-note-ec9b8f1f6fb7.herokuapp.com']
...
ROOT_URLCONF = 'backend.positive.urls'
